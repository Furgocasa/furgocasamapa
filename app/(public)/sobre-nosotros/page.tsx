        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-gray-600 leading-relaxed space-y-6">
              ...
              <p>
                Esta herramienta es un proyecto de <strong>Furgocasa</strong>, empresa con años de experiencia en el sector del caravaning. Gracias a esa experiencia y al feedback constante de miles de usuarios, hemos creado una plataforma que va mucho más allá de un simple mapa de áreas.
              </p>
