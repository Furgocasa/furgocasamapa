...
const GRUPOS: Grupo[] = [
  {
    ...
    sections: [
      ...
      { title: 'Gestión de descripciones', description: 'Revisa, filtra y enriquece los textos de las áreas', icon: <SparklesIcon className="w-6 h-6" />, href: '/admin/areas/enriquecer-textos' },
