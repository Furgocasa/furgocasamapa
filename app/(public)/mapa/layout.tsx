...
export const metadata: Metadata = {
  ...
  description: 'Explora más de 9.000 áreas para autocaravanas en un mapa interactivo. Filtra por servicios, precio y ubicación en Europa, América y resto del mundo. Encuentra tu próxima parada con información actualizada en tiempo real.',
  keywords: [
  ...
  openGraph: {
    title: 'Mapa Interactivo - +9.000 Áreas para Autocaravanas',
